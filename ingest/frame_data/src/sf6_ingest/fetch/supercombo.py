...
def fetch_supercombo_snapshot(character: CharacterConfig, profile: FetchProfile) -> tuple[bytes, SnapshotMetadata]:
    result = fetch_with_profile(character.sources["supercombo_data"], profile)
    metadata = SnapshotMetadata.model_validate(
        {
            ...
            "source_url": character.sources["supercombo_data"],
