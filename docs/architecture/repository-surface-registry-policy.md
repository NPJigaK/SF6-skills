...
| `knowledge_integrity_report` | `data/knowledge-integrity.json` | `tests/validation/validate-knowledge-integrity-report.ps1 -Update` | `knowledge/`, `skills/sf6-agent/references/generated-*` |
