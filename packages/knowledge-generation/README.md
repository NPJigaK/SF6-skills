...
knowledge runtime payloads under `runtime/generated-knowledge/`. It also
refreshes `skills/sf6-agent/references/generated-*` as a deferred public
adapter compatibility copy while that adapter remains.
