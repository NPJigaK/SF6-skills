...
| Page | Summary | Type |
|---|---|---|
| [[entities/street-fighter-6]] | glossary、SuperCombo controls / HUD / Gauges、公式 CAPCOM eSports BASE 用語解説、45 term pages、公式 Fighting Ground Battle System、公式 frame-data sources、公式 Battle Change List、SuperCombo 30キャラ community frame-data 取得データ、Gauges numeric output、公式 + SuperCombo 補助 output、raw layout の game context。 | other |
| [[entities/supercombo-wiki]] | glossary、controls、HUD、Gauges、30キャラ分の SuperCombo frame-data raw 取得データ、Gauges numeric output、公式補助 output の source である community wiki。 | other |
