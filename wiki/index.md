...
| `.agents/skills/sf6-raw-capture-review/SKILL.md` | capture済み raw package の妥当性確認 workflow。manifest、metadata、validation、scope、source freshness、ingest readiness を review し、曖昧な分類例は `references/examples.md` に置く。 | 2026-06-17 |
...
| SuperCombo controls | `raw/web-pages/wiki.supercombo.gg/controls/manifest.json` | `page.raw.wikitext`; 表示証拠は `page.html`、`rendered/main.dom.json`、`rendered/tables.dom.json`; template 依存一覧は `api/templates.json` | `storage_policy: updateable_web_page_capture`; page revid `365425`; `source_updated_at` 2026-06-03T09:40:46Z; `captured_at_utc` 2026-06-11T00:01:49Z |
| SuperCombo HUD | `raw/web-pages/wiki.supercombo.gg/hud/manifest.json` | `page.raw.wikitext`; original HUD media は `images/files/`; rendered HUD media は `images/rendered/`; scoped screenshots は `screenshots/`; template 依存一覧は `api/templates.json` | `storage_policy: updateable_web_page_capture`; page revid `345794`; `source_updated_at` 2026-01-03T12:40:35Z; `captured_at_utc` 2026-06-11T01:00:31Z; content media 14件、navigation / character icon 30件は除外 provenance |
| SuperCombo Gauges | `raw/web-pages/wiki.supercombo.gg/gauges/manifest.json` | `page.raw.wikitext`; original gauge media は `images/files/`; rendered media は `images/rendered/`; rendered numeric tables は `rendered/main.dom.json`; scoped screenshots は `screenshots/`; template 依存一覧は `api/templates.json` | `storage_policy: updateable_web_page_capture`; page revid `365841`; `source_updated_at` 2026-06-07T12:31:40Z; `captured_at_utc` 2026-06-11T01:23:20Z; content tables 0-12、navigation table 13、original media 8件、rendered media 28件 |
| SuperCombo Offense | `raw/web-pages/wiki.supercombo.gg/offense/manifest.json` | `page.raw.wikitext`; 表示証拠は `page.html`、`rendered/main.dom.json`、`rendered/media.dom.json`、scoped screenshots; template 依存一覧は `api/templates.json` | `storage_policy: updateable_web_page_capture`; page revid `364971`; `source_updated_at` 2026-05-30T00:03:21Z; `captured_at_utc` 2026-06-11T11:03:16Z; content table 1件、navigation table 1件、content media 0件、navigation / character icon 30件は除外 provenance |
| SuperCombo Defense | `raw/web-pages/wiki.supercombo.gg/defense/manifest.json` | `page.raw.wikitext`; 表示証拠は `page.html`、`rendered/main.dom.json`、`rendered/media.dom.json`、scoped screenshots; rendered button / direction media は `images/rendered/`; template 依存一覧は `api/templates.json` | `storage_policy: updateable_web_page_capture`; page revid `364973`; `source_updated_at` 2026-05-30T00:09:39Z; `captured_at_utc` 2026-06-11T11:35:33Z; table 1件は navigation、rendered media 14件、navigation / character icon 30件は除外 provenance |
| SuperCombo Game Data | `raw/web-pages/wiki.supercombo.gg/game-data/manifest.json` | `page.raw.wikitext`; 表示証拠は `page.html`、`rendered/main.dom.json`、`rendered/tabbers.dom.json`、scoped screenshots; raw-derived table artifact は `raw/web-pages/wiki.supercombo.gg/game-data/derived/tabber-tables.json`; tabber pipeline は `tools/web_pages/supercombo_page.py` | `storage_policy: updateable_web_page_capture`; page revid `365507`; `source_updated_at` 2026-06-04T23:19:26Z; `captured_at_utc` 2026-06-11T13:38:34Z; tabber validation passed; content tables 39 / navigation table 1 |
| SuperCombo Patch Notes | `raw/web-pages/wiki.supercombo.gg/patch-notes/manifest.json` | `page.raw.wikitext`; version detail pages は `versions/<version-slug>/page.raw.wikitext`; 表示証拠は各 `rendered/main.dom.json` と scoped screenshots; batch 管理は `version-captures.json` / `validation.batch.json` | `storage_policy: updateable_web_page_capture`; Patch Notes root revid `276775`; root `source_updated_at` 2023-09-27T14:23:05Z; detail page 17件; latest detail `latest_detail_source_updated_at` 2026-06-02T03:12:40Z; `captured_at_utc` 2026-06-11T03:22:47Z; official crosswalk 16 matched / 1 launch / 4 official-only; community change events 1374 / target index 1118; upstream derived は `tools.battle_change.supercombo.extract` で再生成 |
...
| [[sources/supercombo-street-fighter-6-controls]] | SuperCombo Wiki の Street Fighter 6 controls。Classic / Modern control type、numpad notation、classic notation、button nickname を MediaWiki wikitext、HTML、rendered DOM として保持する。 | 2026-06-03 | wiki_page | active |
| [[sources/supercombo-street-fighter-6-hud]] | SuperCombo Wiki の Street Fighter 6 HUD。Battle HUD、HUD icon、Health Bar Reference を MediaWiki wikitext、HUD semantic media 14件、scoped screenshots として保持する。navigation / character icon 30件は除外 provenance として記録する。 | 2026-01-03 | wiki_page | active |
| [[sources/supercombo-street-fighter-6-gauges]] | SuperCombo Wiki の Street Fighter 6 Gauges。Drive / Super Gauge cost、regeneration、cooldown、Drive Impact / Drive Rush frame・distance table、本文 media 8件を保持し、数値表は `wiki/outputs/data/gauges/supercombo/numeric-tables.json` にも派生出力する。 | 2026-06-07 | wiki_page | active |
| [[sources/supercombo-street-fighter-6-offense]] | SuperCombo Wiki の Street Fighter 6 Offense。通常投げ、throw range / invincibility、throw loop、Counter / Punish Counter、corner dizzy、blockstring、safe jump、empty jump mixup を MediaWiki wikitext、rendered DOM、scoped screenshots として保持する。 | 2026-05-30 | wiki_page | active |
| [[sources/supercombo-street-fighter-6-defense]] | SuperCombo Wiki の Street Fighter 6 Defense。blocking、throw escape、Drive Parry、wake-up、reversal buffer、armor、anti-air、punish route を MediaWiki wikitext、rendered DOM、button / direction media、scoped screenshots として保持する。 | 2026-05-30 | wiki_page | active |
| [[sources/supercombo-street-fighter-6-game-data]] | SuperCombo Wiki の Street Fighter 6 Game Data。Damage Scaling、System Data、Range Comparisons、Longest Punish の tabbed tables を MediaWiki wikitext、rendered DOM、tabber validation、raw-derived table artifact として保持する。 | 2026-06-04 | wiki_page | active |
| [[sources/supercombo-street-fighter-6-patch-notes]] | SuperCombo Wiki の Street Fighter 6 Patch Notes と 17 version detail pages。root page と detail page の freshness を分け、Capcom 公式 Battle Change List との crosswalk と community change-event index 1374 events / 1118 targets を派生出力する。 | 2023-09-27..2026-06-02 | wiki_page | active |
...
| [[sources/capcom-official-battle-change-list]] | Capcom 公式 Battle Change List capture。20 update version、policy 123 rows / common 100 rows / fighter 1597 rows、change event 1820 rows、move / target index 1419 rows の派生 output を含む。2023.09.27 update の `10000（1ブロック）` 表記を Drive Gauge unit の公式根拠として参照する。 | 2026-06-06 | official_battle_change | active |

## Concepts

| Page | Summary | Related |
|---|---|---|
| [[concepts/terms/index]] | SF6 用語の統合 index。Capcom eSports BASE、Capcom Fighting Ground、SuperCombo glossary、SuperCombo HUD / Gauges / Offense / Defense / Game Data 由来の term / numeric concept pages を集約し、公式 / community / HUD display cue / numeric source claims と、Drive / Super Gauge / Offense / Defense / Game Data 系の索引方針を保持する。 | [[concepts/defense]], [[concepts/offense]], [[concepts/drive-system]], [[concepts/frame-data]], [[concepts/system-data]], [[concepts/range-comparisons]], [[concepts/fighting-game-notation]], [[concepts/juggle-system]], [[entities/street-fighter-6]] |
| [[concepts/offense]] | 通常投げ、throw loop、safe jump、empty jump、blockstring、counter state、corner dizzy などの攻めの横断入口。公式 terms を優先しつつ、SuperCombo Offense の community timing / tactical source facts を補助根拠として保持する。 | [[concepts/terms/throw]], [[concepts/terms/throw-loop]], [[concepts/terms/safe-jump]], [[concepts/terms/empty-jump-mixup]], [[concepts/terms/blockstring]], [[concepts/frame-data]], [[concepts/drive-system]], [[entities/street-fighter-6]] |
| [[concepts/defense]] | blocking、throw escape、Drive Parry、wake-up、reversal buffer、armor、anti-air、punish route などの守りの横断入口。公式 terms を優先しつつ、SuperCombo Defense の community defensive timing / tactical source facts を補助根拠として保持する。 | [[concepts/terms/blocking]], [[concepts/terms/throw-escape]], [[concepts/terms/wake-up]], [[concepts/terms/reversal]], [[concepts/terms/armor]], [[concepts/terms/anti-air]], [[concepts/frame-data]], [[concepts/drive-system]], [[entities/street-fighter-6]] |
| [[concepts/drive-system]] | Drive gauge に紐づく movement、offense、defense、burnout などの共通 system。Capcom 公式 source を mechanics の主根拠にし、SuperCombo HUD を visual source、SuperCombo Gauges を cost / regeneration / cooldown / range の community numeric source、Capcom Battle Change を `10000（1ブロック）` の公式 unit source として補う。 | [[concepts/terms/index]], [[concepts/defense]], [[concepts/offense]], [[concepts/terms/burnout]], [[concepts/terms/drive-impact]], [[concepts/terms/drive-parry]], [[concepts/terms/raw-drive-rush]], [[concepts/terms/drive-reversal]], [[concepts/terms/armor]], [[concepts/frame-data]], [[entities/street-fighter-6]] |
| [[concepts/frame-data]] | 技の timing/property vocabulary、Capcom 公式 eSports BASE の frame / counter / hit confirm 観戦用語、Capcom 公式 Battle Change List と公式 change-event index、SuperCombo Patch Notes の community change-event index、SuperCombo HUD icon の display cue、SuperCombo Gauges の Drive move frame / distance 数値索引、SuperCombo Offense の throw / safe jump / blockstring timing、SuperCombo Defense の throw escape / wake-up / reversal / punish timing、SuperCombo Game Data の scalar timing values / system data / range comparison / punish option tables、30 character data slugs 分の公式 Classic / Modern coverage、SuperCombo 30キャラ community raw 取得データ、公式 + SuperCombo 補助列付き output、最新ミラー raw 配置方針、SuperCombo review queue 優先順。 | [[concepts/terms/index]], [[concepts/defense]], [[concepts/offense]], [[concepts/drive-system]], [[concepts/system-data]], [[concepts/range-comparisons]], [[concepts/juggle-system]], [[concepts/fighting-game-notation]], [[reviews/2026-06-06-supercombo-field-conflict-queue-prereview]], [[entities/street-fighter-6]] |
| [[concepts/combo-damage-ledger-protocol]] | Exact combo damage の回答前に通す hit ledger preflight。`最速入力`、delayed hit、SA/install、portal、multi-hit、juggle、距離依存 route では hit order proof を作り、source が足りない場合は確定値として答えず fail closed する。 | [[concepts/terms/damage-scaling]], [[concepts/frame-data]], [[concepts/juggle-system]], [[reviews/2026-06-15-jp-combo-damage-ledger-regression]] |
| [[concepts/system-data]] | SuperCombo Game Data の General Data、Movement Data、Jump Data を full table として昇格した community numeric source page。HP、throw range、walk speed、dash speed / distance、jump speed / distance / apex を保持する。 | [[concepts/frame-data]], [[concepts/range-comparisons]], [[concepts/terms/throw]], [[entities/street-fighter-6]] |
| [[concepts/range-comparisons]] | SuperCombo Game Data の Cancelable 2MK Range、4f Normal Range / Hitstun / Pushback、5f Punish Options、Sweep Ranges を full table として昇格した community numeric source page。 | [[concepts/frame-data]], [[concepts/system-data]], [[concepts/terms/guaranteed-punish]], [[concepts/terms/whiff-punish]], [[entities/street-fighter-6]] |
...
| [[concepts/fighting-game-notation]] | link、cancel、hold/release、chain、hit state、air action、delay、directional input、button notation。SuperCombo glossary の `ComboLegend-SF6` template と SuperCombo controls の numpad / classic notation を根拠にする。 | [[concepts/frame-data]], [[concepts/terms/cancel]], [[concepts/terms/chain]] |
...
| [[concepts/terms/anti-air]] | 対空 / anti-air | Capcom eSports BASE, SuperCombo Defense | [[concepts/defense]], [[concepts/drive-system]], [[concepts/terms/cross-up]] |
| [[concepts/terms/armor]] | Armor / アーマー | SuperCombo Defense, SuperCombo Gauges | [[concepts/defense]], [[concepts/drive-system]], [[concepts/terms/drive-impact]], [[concepts/terms/armor-break]] |
...
| [[concepts/terms/blocking]] | Blocking / ガード | SuperCombo Defense | [[concepts/defense]], [[concepts/terms/blockstring]], [[concepts/terms/cross-up]], [[concepts/terms/drive-parry]] |
| [[concepts/terms/blockstring]] | Blockstring / 固め | SuperCombo Offense, SuperCombo Defense | [[concepts/offense]], [[concepts/defense]], [[concepts/frame-data]], [[concepts/terms/chain]], [[concepts/terms/cancel]] |
| [[concepts/terms/burnout]] | バーンアウト / Burnout | Capcom Fighting Ground, Capcom eSports BASE, SuperCombo glossary, SuperCombo Gauges | [[concepts/drive-system]], [[concepts/terms/chip-damage]], [[concepts/terms/stun]] |
...
| [[concepts/terms/chip-damage]] | 削り / chip damage | Capcom eSports BASE, SuperCombo Gauges | [[concepts/drive-system]], [[concepts/terms/burnout]] |
...
| [[concepts/terms/counter-hit]] | Counter-hit / カウンターヒット | Capcom eSports BASE, SuperCombo HUD, SuperCombo Offense | [[concepts/frame-data]], [[concepts/offense]], [[concepts/terms/frame-advantage]], [[concepts/terms/punish-counter]] |
| [[concepts/terms/critical-art]] | Critical Art / CA | SuperCombo Gauges, Official Zangief frame data, SuperCombo Zangief frame data | [[concepts/terms/super-art]], [[concepts/frame-data]] |
| [[concepts/terms/cross-up]] | めくり / cross-up | Capcom eSports BASE, SuperCombo HUD, SuperCombo Defense | [[concepts/defense]], [[concepts/terms/blocking]], [[concepts/terms/anti-air]], [[concepts/terms/oki]] |
...
| [[concepts/terms/damage-scaling]] | ダメージ補正 / damage scaling | Capcom eSports BASE, SuperCombo glossary, SuperCombo Gauges, SuperCombo Game Data | [[concepts/frame-data]], [[concepts/combo-damage-ledger-protocol]], [[concepts/terms/scaling-reset]] |
| [[concepts/terms/drive-impact]] | Drive Impact / ドライブインパクト | Capcom Fighting Ground, Capcom eSports BASE, SuperCombo glossary, SuperCombo HUD, SuperCombo Gauges | [[concepts/drive-system]], [[concepts/terms/drive-impact-counter]], [[concepts/terms/wall-bounce]], [[concepts/terms/armor-break]], [[concepts/terms/crush]], [[concepts/terms/lock]] |
...
| [[concepts/terms/drive-parry]] | Drive Parry / ドライブパリィ | Capcom Fighting Ground, Capcom eSports BASE, SuperCombo glossary, SuperCombo Gauges, SuperCombo Defense | [[concepts/drive-system]], [[concepts/defense]], [[concepts/terms/blocking]], [[concepts/terms/perfect-parry]], [[concepts/terms/raw-drive-rush]] |
| [[concepts/terms/drive-reversal]] | Drive Reversal / ドライブリバーサル | Capcom Fighting Ground, SuperCombo glossary, SuperCombo Gauges | [[concepts/drive-system]], [[concepts/terms/invincible-move]] |
| [[concepts/terms/drive-rush-cancel]] | Drive Rush Cancel / DRC / キャンセルラッシュ | Capcom Fighting Ground, Capcom eSports BASE, SuperCombo glossary, SuperCombo Gauges | [[concepts/drive-system]], [[concepts/terms/cancel]], [[concepts/terms/frame-advantage]] |
| [[concepts/terms/empty-jump-mixup]] | Empty Jump Mixup / 空ジャンプ択 | SuperCombo Offense | [[concepts/offense]], [[concepts/terms/safe-jump]], [[concepts/terms/throw]], [[concepts/terms/oki]] |
...
| [[concepts/terms/guaranteed-punish]] | 確定反撃 / guaranteed punish | Capcom eSports BASE, SuperCombo Defense, SuperCombo Game Data | [[concepts/defense]], [[concepts/range-comparisons]], [[concepts/terms/frame-advantage]], [[concepts/terms/punish-counter]] |
...
| [[concepts/terms/invincible-move]] | 無敵技 / invincible move | Capcom eSports BASE, SuperCombo Defense | [[concepts/defense]], [[concepts/terms/abare]], [[concepts/terms/reversal]], [[concepts/terms/drive-reversal]] |
...
| [[concepts/terms/overdrive]] | Overdrive / OD | Capcom Fighting Ground, SuperCombo glossary, SuperCombo Gauges | [[concepts/drive-system]], [[concepts/terms/burnout]] |
| [[concepts/terms/perfect-parry]] | ジャストパリィ / Perfect Parry | Capcom eSports BASE, SuperCombo Gauges | [[concepts/drive-system]], [[concepts/terms/drive-parry]], [[concepts/terms/damage-scaling]] |
| [[concepts/terms/punish-counter]] | パニッシュカウンター / Punish Counter | Capcom eSports BASE, SuperCombo HUD, SuperCombo Offense | [[concepts/frame-data]], [[concepts/offense]], [[concepts/terms/guaranteed-punish]], [[concepts/terms/counter-hit]], [[concepts/terms/throw]] |
| [[concepts/terms/raw-drive-rush]] | 生ラッシュ / raw Drive Rush | Capcom eSports BASE, Capcom Fighting Ground, SuperCombo Gauges, official frame data, PDR cost component review | [[concepts/drive-system]], [[concepts/terms/drive-parry]], [[concepts/terms/frame-advantage]], [[reviews/2026-06-15-pdr-cost-component-video-observation]] |
| [[concepts/terms/reversal]] | Reversal / リバーサル | SuperCombo HUD, SuperCombo Defense | [[concepts/defense]], [[concepts/frame-data]], [[concepts/terms/wake-up]], [[concepts/terms/invincible-move]], [[concepts/terms/drive-reversal]] |
| [[concepts/terms/safe-jump]] | Safe Jump / 安全飛び | SuperCombo Offense | [[concepts/offense]], [[concepts/terms/oki]], [[concepts/terms/reversal]], [[concepts/terms/perfect-parry]] |
...
| [[concepts/terms/stun]] | スタン / Stun/Dizzy | Capcom eSports BASE, SuperCombo HUD, SuperCombo Gauges, SuperCombo Offense | [[concepts/drive-system]], [[concepts/offense]], [[concepts/terms/burnout]], [[concepts/terms/corner]], [[concepts/terms/drive-impact]] |
| [[concepts/terms/super-art]] | Super Art / SA | Capcom Fighting Ground, SuperCombo glossary, SuperCombo Gauges | [[concepts/frame-data]], [[concepts/terms/critical-art]], [[concepts/terms/cancel]] |
| [[concepts/terms/throw]] | Throw / 投げ | SuperCombo Offense | [[concepts/offense]], [[concepts/terms/throw-loop]], [[concepts/terms/command-throw]], [[concepts/terms/throw-escape]] |
| [[concepts/terms/throw-escape]] | Throw Escape / Throw Tech | SuperCombo HUD, SuperCombo Defense | [[concepts/defense]], [[concepts/terms/throw]], [[concepts/terms/shimmy]], [[concepts/terms/punish-counter]] |
| [[concepts/terms/throw-loop]] | Throw Loop / 投げループ | SuperCombo Offense | [[concepts/offense]], [[concepts/terms/throw]], [[concepts/terms/oki]], [[concepts/terms/meaty]] |
| [[concepts/terms/wake-up]] | Wake-up / 起き上がり | SuperCombo Defense, SuperCombo HUD | [[concepts/defense]], [[concepts/offense]], [[concepts/terms/oki]], [[concepts/terms/reversal]] |
...
| Page | Summary | Type |
|---|---|---|
| [[entities/street-fighter-6]] | glossary、SuperCombo controls / HUD / Gauges / Offense / Defense / Patch Notes、公式 CAPCOM eSports BASE 用語解説、53 term pages、公式 Fighting Ground Battle System、公式 frame-data sources、公式 Battle Change List、SuperCombo 30キャラ community frame-data 取得データ、Gauges numeric output、Patch Notes crosswalk、公式 + SuperCombo 補助 output、raw layout の game context。 | other |
| [[entities/supercombo-wiki]] | glossary、controls、HUD、Gauges、Offense、Defense、Patch Notes、30キャラ分の SuperCombo frame-data raw 取得データ、Gauges numeric output、公式補助 output の source である community wiki。 | other |
...
|---|---|---|---:|
| [[outputs/lint/2026-06-11-health-check]] | lint_report | 2026-06-11 追加分を中心にした wiki health check。JP / Ryu `captured_at_utc`、Patch Notes freshness、batch `raw_path` pattern を同期した。PDR cost 表記揺れの未解決扱いは 2026-06-15 の component / total 整理で superseded。 | 2026-06-15 |
...
| [[outputs/reports/2026-06-11-jp-year1-od-amnesia-5790-damage-calculation]] | report | JP Year1 初期 ODアムネジア始動ルートの 5790 damage を、yt-dlp 確認動画、JP frame-data、SuperCombo 補助値、2024-02-27 Battle Change から照合する。SA3 は source-backed full move total segment として legacy fixture に保持する。 | 2026-06-16 |
| [[outputs/reports/2026-06-16-calculation-system-future-readiness-review]] | report | 将来の combo prediction / postmortem / gauge / juggle / timing proof に備え、計算系で固定すべき evidence、authority、fixture promotion、prediction immutability、schema format、test boundary を整理する。 | 2026-06-16 |
...
| `wiki/outputs/data/battle-change/official/` | json | Capcom 公式 Battle Change List 20 version 分の派生 output。`changes.json` は policy / common / fighter change rows 1820 行を保持し、`change-events.json` と `move-change-index.json` は combo / frame-data query の原因候補検索用 index として 1820 events / 1419 targets を保持する。fighter rows は公式 source key と frame-data join 用 `character_slug` を分ける。 | 2026-06-11 |
| `wiki/outputs/data/battle-change/supercombo-patch-notes/` | json | SuperCombo Patch Notes 17 version rows、Capcom 公式 Battle Change List との crosswalk、detail page top-level bullets の community `change-events.json` 1374 events / `move-change-index.json` 1118 targets。明示 link 16 rows、launch 1 row、official-only 4 rowsを保持し、fighter rows は `fighter_key` と frame-data join 用 `character_slug` を分ける。 | 2026-06-11 |
| `wiki/outputs/data/gauges/supercombo/numeric-tables.json` | json | SuperCombo Gauges の content table 0-12 と、Drive action cost、Drive Impact / Drive Rush distance、regeneration / cooldown、Super Gauge などの正規化数値を保持する source-preserving derived output。PDR は `cost_bars` を単一 direct cost として使わず、transition component と minimum total を専用 field に分ける。 | 2026-06-15 |
| `wiki/outputs/data/calculations/combo-damage/schema.json` | contract_descriptor | Source-backed hit ledger を入力にした deterministic combo damage calculation output の repo-local contract descriptor。SymPy 依存、per-hit floor、source path / input hash / calculator version / authority、明示 scaling factor、`attack_step` / `scaling_note` trace を contract 化し、candidate authority や非明示 hit 推測は拒否する。 | 2026-06-16 |
...
| [[reviews/2026-06-11-supercombo-controls-web-page-capture-review]] | capture_validation | SuperCombo controls を `raw/web-pages/` layout で取得。MediaWiki wikitext を canonical raw 取得物、HTML / rendered DOM を表示構造と notation table の証拠として保存した。 | open |
| [[reviews/2026-06-11-supercombo-hud-web-page-capture-review]] | capture_validation | SuperCombo HUD を `raw/web-pages/` layout で取得。HUD semantic media 14件と scoped screenshots を保存し、navigation / character icon 30件は除外 provenance として記録した。 | open |
| [[reviews/2026-06-11-supercombo-gauges-web-page-capture-review]] | capture_validation | SuperCombo Gauges を `raw/web-pages/` layout で取得。Drive / Super Gauge の数値表、content media 8件、rendered media 28件、scoped screenshots、numeric derived output を保存した。 | open |
| [[reviews/2026-06-11-supercombo-offense-web-page-capture-review]] | capture_validation | SuperCombo Offense を `raw/web-pages/` layout で取得。通常投げ、throw range / invincibility、throw loop、Counter / Punish Counter、safe jump、empty jump、blockstring を source page と term pages に集約した。 | open |
| [[reviews/2026-06-11-supercombo-defense-web-page-capture-review]] | capture_validation | SuperCombo Defense を `raw/web-pages/` layout で取得。blocking、throw escape、Drive Parry、wake-up、reversal buffer、armor、anti-air、punish route を source page と term pages に集約した。 | open |
