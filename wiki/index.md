...
|---|---|---|
| [[concepts/terms/index]] | SF6 用語の統合 index。Capcom eSports BASE、Capcom Fighting Ground、SuperCombo glossary、SuperCombo HUD / Gauges / Offense 由来の 50 個別 term pages を集約し、公式 / community / HUD display cue / numeric source claims と、Drive / Super Gauge / Offense 系 term の索引方針を保持する。 | [[concepts/offense]], [[concepts/drive-system]], [[concepts/frame-data]], [[concepts/fighting-game-notation]], [[concepts/juggle-system]], [[entities/street-fighter-6]] |
...
| [[concepts/drive-system]] | Drive gauge に紐づく movement、offense、defense、burnout などの共通 system。Capcom 公式 source を mechanics の主根拠にし、SuperCombo HUD を visual source、SuperCombo Gauges を cost / regeneration / cooldown / range の community numeric source、SuperCombo Offense を Drive Rush / Drive Parry の攻め文脈 source として補う。 | [[concepts/terms/index]], [[concepts/offense]], [[concepts/terms/burnout]], [[concepts/terms/drive-impact]], [[concepts/terms/drive-parry]], [[concepts/terms/drive-reversal]], [[concepts/terms/drive-rush-cancel]], [[concepts/frame-data]], [[entities/street-fighter-6]] |
| [[concepts/frame-data]] | 技の timing/property vocabulary、Capcom 公式 eSports BASE の frame / counter / hit confirm 観戦用語、Capcom 公式 Battle Change List と公式 change-event index、SuperCombo Patch Notes の community change-event index、SuperCombo HUD icon の display cue、SuperCombo Gauges の Drive move frame / distance 数値索引、SuperCombo Offense の throw / safe jump / blockstring timing、30 character data slugs 分の公式 Classic / Modern coverage、SuperCombo 30キャラ community raw 取得データ、公式 + SuperCombo 補助列付き output、最新ミラー raw 配置方針、SuperCombo review queue 優先順。 | [[concepts/terms/index]], [[concepts/offense]], [[concepts/drive-system]], [[concepts/juggle-system]], [[concepts/fighting-game-notation]], [[reviews/2026-06-06-supercombo-field-conflict-queue-prereview]], [[entities/street-fighter-6]] |
...
| [[concepts/terms/blockstring]] | Blockstring / 固め | SuperCombo Offense | [[concepts/offense]], [[concepts/frame-data]], [[concepts/terms/chain]], [[concepts/terms/cancel]] |
...
| [[concepts/terms/drive-parry]] | Drive Parry / ドライブパリィ | Capcom Fighting Ground, Capcom eSports BASE, SuperCombo glossary, SuperCombo Gauges | [[concepts/drive-system]], [[concepts/terms/perfect-parry]], [[concepts/terms/raw-drive-rush]] |
...
| Page | Summary | Type |
|---|---|---|
| [[entities/street-fighter-6]] | glossary、SuperCombo controls / HUD / Gauges / Offense / Patch Notes、公式 CAPCOM eSports BASE 用語解説、50 term pages、公式 Fighting Ground Battle System、公式 frame-data sources、公式 Battle Change List、SuperCombo 30キャラ community frame-data 取得データ、Gauges numeric output、Patch Notes crosswalk、公式 + SuperCombo 補助 output、raw layout の game context。 | other |
| [[entities/supercombo-wiki]] | glossary、controls、HUD、Gauges、Offense、Patch Notes、30キャラ分の SuperCombo frame-data raw 取得データ、Gauges numeric output、公式補助 output の source である community wiki。 | other |
