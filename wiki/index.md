...
|---|---|---|
| [[concepts/terms/index]] | SF6 用語の統合 index。Capcom eSports BASE、Capcom Fighting Ground、SuperCombo glossary、SuperCombo HUD / Gauges / Offense / Defense 由来の 53 個別 term pages を集約し、公式 / community / HUD display cue / numeric source claims と、Drive / Super Gauge / Offense / Defense 系 term の索引方針を保持する。 | [[concepts/defense]], [[concepts/offense]], [[concepts/drive-system]], [[concepts/frame-data]], [[concepts/fighting-game-notation]], [[concepts/juggle-system]], [[entities/street-fighter-6]] |
...
| [[concepts/frame-data]] | 技の timing/property vocabulary、Capcom 公式 eSports BASE の frame / counter / hit confirm 観戦用語、Capcom 公式 Battle Change List と公式 change-event index、SuperCombo Patch Notes の community change-event index、SuperCombo HUD icon の display cue、SuperCombo Gauges の Drive move frame / distance 数値索引、SuperCombo Offense の throw / safe jump / blockstring timing、SuperCombo Defense の throw escape / wake-up / reversal / punish timing、30 character data slugs 分の公式 Classic / Modern coverage、SuperCombo 30キャラ community raw 取得データ、公式 + SuperCombo 補助列付き output、最新ミラー raw 配置方針、SuperCombo review queue 優先順。 | [[concepts/terms/index]], [[concepts/defense]], [[concepts/offense]], [[concepts/drive-system]], [[concepts/juggle-system]], [[concepts/fighting-game-notation]], [[reviews/2026-06-06-supercombo-field-conflict-queue-prereview]], [[entities/street-fighter-6]] |
...
| [[concepts/terms/damage-scaling]] | ダメージ補正 / damage scaling | Capcom eSports BASE, SuperCombo glossary, SuperCombo Gauges | [[concepts/frame-data]], [[concepts/terms/scaling-reset]] |
...
| [[concepts/terms/guaranteed-punish]] | 確定反撃 / guaranteed punish | Capcom eSports BASE, SuperCombo Defense | [[concepts/defense]], [[concepts/terms/frame-advantage]], [[concepts/terms/punish-counter]] |
