...
| [[concepts/terms/damage-scaling]] | ダメージ補正 / damage scaling | Capcom eSports BASE, SuperCombo glossary, SuperCombo Gauges, SuperCombo Game Data | [[concepts/frame-data]], [[concepts/terms/scaling-reset]] |
...
| [[outputs/reports/2026-06-11-jp-year1-od-amnesia-5790-damage-calculation]] | report | JP Year1 初期 ODアムネジア始動ルートの 5790 damage を、yt-dlp 確認動画、JP frame-data、SuperCombo 補助値、2024-02-27 Battle Change から hit-by-hit に再計算する。 | 2026-06-11 |
...
| [[reviews/2026-06-11-jp-year1-od-amnesia-combo-damage-calculation-model-gap]] | calculation_model_gap | JP Year1 初期 ODアムネジア始動ルートの 5790 damage は repo 内数値から再計算可能だった。原因は source gap ではなく、delayed hit、patch rollback、PC倍率、SA最低保証を含む hit ledger を作らなかったこと。 | open |
