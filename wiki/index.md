...
| SuperCombo Patch Notes | `raw/web-pages/wiki.supercombo.gg/patch-notes/manifest.json` | `page.raw.wikitext`; version detail pages は `versions/<version-slug>/page.raw.wikitext`; 表示証拠は各 `rendered/main.dom.json` と scoped screenshots; batch 管理は `version-captures.json` / `validation.batch.json` | `storage_policy: updateable_web_page_capture`; Patch Notes page revid `276775`; detail page 17件; latest detail `source_updated_at` 2026-06-02T03:12:40Z; `captured_at_utc` 2026-06-11T03:22:47Z; official crosswalk 16 matched / 1 launch / 4 official-only; community change events 1374 / target index 1118; upstream derived は `tools.battle_change.supercombo.extract` で再生成 |
...
| [[sources/supercombo-street-fighter-6-patch-notes]] | SuperCombo Wiki の Street Fighter 6 Patch Notes と 17 version detail pages。version detail wikitext を raw 保存し、Capcom 公式 Battle Change List との crosswalk と community change-event index 1374 events / 1118 targets を派生出力する。 | 2026-06-02 | wiki_page | active |
...
| [[sources/capcom-official-battle-change-list]] | Capcom 公式 Battle Change List capture。20 update version、policy 123 rows / common 100 rows / fighter 1597 rows、change event 1820 rows、move / target index 1419 rows の派生 output を含む。 | 2026-06-06 | official_battle_change | active |
...
| [[concepts/drive-system]] | Drive gauge に紐づく movement、offense、defense、burnout などの共通 system。Capcom 公式 source を mechanics の主根拠にし、SuperCombo HUD を visual source、SuperCombo Gauges を cost / regeneration / cooldown / range の community numeric source、SuperCombo Offense を攻め文脈 source、SuperCombo Defense を Drive Parry / armor の守り文脈 source として補う。 | [[concepts/terms/index]], [[concepts/defense]], [[concepts/offense]], [[concepts/terms/burnout]], [[concepts/terms/drive-impact]], [[concepts/terms/drive-parry]], [[concepts/terms/drive-reversal]], [[concepts/terms/armor]], [[concepts/frame-data]], [[entities/street-fighter-6]] |
...
| [[concepts/terms/raw-drive-rush]] | 生ラッシュ / raw Drive Rush | Capcom eSports BASE, Capcom Fighting Ground, SuperCombo Gauges | [[concepts/drive-system]], [[concepts/terms/drive-parry]], [[concepts/terms/frame-advantage]] |
...
| `wiki/outputs/data/gauges/supercombo/numeric-tables.json` | json | SuperCombo Gauges の content table 0-12 と、Drive action cost、Drive Impact / Drive Rush distance、regeneration / cooldown、Super Gauge などの正規化数値を保持する source-preserving derived output。 | 2026-06-11 |
