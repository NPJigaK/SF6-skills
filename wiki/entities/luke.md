...
Luke is a Street Fighter 6 character covered by an official Capcom
frame-data capture in this wiki. The captured page uses the data slug
`luke` and the Japanese page name `ルーク`.
...
- The official capture contains 76 Classic frame-data rows and 73
