...
Guile is a Street Fighter 6 character covered by an official Capcom
frame-data capture in this wiki. The captured page uses the data slug
`guile` and the Japanese page name `ガイル`.
...
- The official capture contains 80 Classic frame-data rows and 76
