...
Jamie is a Street Fighter 6 character covered by an official Capcom
frame-data capture in this wiki. The captured page uses the data slug
`jamie` and the Japanese page name `ジェイミー`.
...
- The official capture contains 103 Classic frame-data rows and 98
