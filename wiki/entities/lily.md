...
Lily is a Street Fighter 6 character covered by an official Capcom
frame-data capture in this wiki. The captured page uses the data slug
`lily` and the Japanese page name `リリー`.
...
- The official capture contains 74 Classic frame-data rows and 71
