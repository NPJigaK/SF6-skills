...
Terry is a Street Fighter 6 character covered by an official Capcom
frame-data capture in this wiki. The captured page uses the data slug
`terry` and the Japanese page name `テリー`.
...
- The official capture contains 66 Classic frame-data rows and 60
