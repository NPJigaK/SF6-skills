...
Ken is a Street Fighter 6 character covered by an official Capcom
frame-data capture in this wiki. The captured page uses the data slug
`ken` and the Japanese page name `ケン`.
...
- The official capture contains 76 Classic frame-data rows and 71
