...
Rashid is a Street Fighter 6 character covered by an official Capcom
frame-data capture in this wiki. The captured page uses the data slug
`rashid` and the Japanese page name `ラシード`.
...
- The official capture contains 85 Classic frame-data rows and 72
