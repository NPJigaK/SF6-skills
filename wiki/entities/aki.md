...
A.K.I. is a Street Fighter 6 character covered by an official Capcom
frame-data capture in this wiki. The captured page uses the data slug
`aki` and the Japanese page name `A.K.I.`.
...
- The official capture contains 64 Classic frame-data rows and 57
