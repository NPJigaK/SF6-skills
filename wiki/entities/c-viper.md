...
C. Viper is a Street Fighter 6 character covered by an official Capcom
frame-data capture in this wiki. The captured page uses the data slug
`cviper` and the Japanese page name `C.ヴァイパー`.
...
- The official capture contains 69 Classic frame-data rows and 67
