...
Elena is a Street Fighter 6 character covered by an official Capcom
frame-data capture in this wiki. The captured page uses the data slug
`elena` and the Japanese page name `エレナ`.
...
- The official capture contains 79 Classic frame-data rows and 74
