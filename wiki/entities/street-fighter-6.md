...
- SuperCombo HUD は Battle HUD の表示要素、HUD icon、Health Bar Reference の community / visual source として保持する。navigation / character icon は HUD source content として扱わず、raw media download から除外した。
