...
- 個別技の値は entity page では要約せず、`wiki/outputs/data/frame-data/official/ingrid/` の公式 CSV、`wiki/outputs/data/frame-data/official-supercombo-enriched/ingrid/` の補助列付き CSV、raw DOM を source-preserving data として参照する。
