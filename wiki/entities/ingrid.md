...
- 個別技の値は entity page では要約せず、`wiki/outputs/data/frame-data/ingrid/` の公式 CSV、`wiki/outputs/data/enriched/frame-data/ingrid/` の補助列付き CSV、raw DOM を source-preserving data として参照する。
