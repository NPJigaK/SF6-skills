...
Mai is a Street Fighter 6 character covered by an official Capcom
frame-data capture in this wiki. The captured page uses the data slug
`mai` and the Japanese page name `舞`.
...
- The official capture contains 90 Classic frame-data rows and 85
