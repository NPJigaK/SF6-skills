...
Gouki / Akuma is a Street Fighter 6 character covered by an official Capcom
frame-data capture in this wiki. The captured page uses the data slug
`gouki_akuma` and the Japanese page name `豪鬼`.
...
- The official capture contains 91 Classic frame-data rows and 83
