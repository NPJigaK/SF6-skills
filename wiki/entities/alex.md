...
Alex is a Street Fighter 6 character covered by an official Capcom
frame-data capture in this wiki. The captured page uses the data slug
`alex` and the Japanese page name `アレックス`.
...
- The official capture contains 74 Classic frame-data rows and 73
