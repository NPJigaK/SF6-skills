...
Capcom は、この wiki に保存されている Street Fighter 6 公式フレームデータ source と公式 Battle Change List source の publisher。
...
- 公式 Battle Change List は 2023-07-24 update から 2026-05-28 update までの 20 version を持ち、この wiki では raw HTML / Next.js data JSON と派生 CSV / JSON を保持する。
...
- Battle Change List の個別 version / character 変更を、どの粒度で wiki page へ昇格するか。
