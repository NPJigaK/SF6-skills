...
SuperCombo Zangief raw 取得データからレビュー用の派生 CSV/JSON を作成し、Capcom 公式 Zangief Classic CSV との候補照合を生成した。これは最終マージではなく、公式 data を正としたまま SuperCombo の `move_id`、range、juggle、notes、画像をどの公式 row に紐づけられるか確認するためのレビュー面。2026-06-02 にレビュー対象 25 行を人間レビューし、公式値を正とした補助リンクとして accepted にした。

この照合を使った補助列付き output は [[outputs/reports/2026-06-02-zangief-official-supercombo-enriched-data]] に保存している。

## 生成ファイル

- `wiki/outputs/data/supercombo/frame-data/zangief/frames.csv`
- `wiki/outputs/data/supercombo/frame-data/zangief/frames.json`
- `wiki/outputs/data/supercombo/frame-data/zangief/character.csv`
- `wiki/outputs/data/supercombo/frame-data/zangief/schema.json`
- `wiki/outputs/data/supercombo/frame-data/zangief/crosswalk-official-classic.csv`
- `wiki/outputs/data/supercombo/frame-data/zangief/crosswalk-summary.json`
- `wiki/outputs/data/supercombo/frame-data/zangief/supercombo-unmatched.csv`
...
- この report はレビュー用であり、`wiki/outputs/data/frame-data/zangief/` の公式 CSV を置き換えない。
...
- 照合 summary: `wiki/outputs/data/supercombo/frame-data/zangief/crosswalk-summary.json`
