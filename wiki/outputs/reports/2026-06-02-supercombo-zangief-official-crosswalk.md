...
- `wiki/outputs/data/frame-data/supercombo/zangief/frames.csv`
- `wiki/outputs/data/frame-data/supercombo/zangief/frames.json`
- `wiki/outputs/data/frame-data/supercombo/zangief/character.csv`
- `wiki/outputs/data/frame-data/supercombo/zangief/schema.json`
- `wiki/outputs/data/frame-data/supercombo/zangief/crosswalk-official-classic.csv`
- `wiki/outputs/data/frame-data/supercombo/zangief/crosswalk-summary.json`
- `wiki/outputs/data/frame-data/supercombo/zangief/supercombo-unmatched.csv`
...
- この report はレビュー用であり、`wiki/outputs/data/frame-data/official/zangief/` の公式 CSV を置き換えない。
