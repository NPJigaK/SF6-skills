...
- `wiki/outputs/data/frame-data/official-supercombo-enriched/jp/classic-supercombo.csv`
- `wiki/outputs/data/frame-data/official-supercombo-enriched/jp/classic-supercombo.json`
- `wiki/outputs/data/frame-data/official-supercombo-enriched/jp/supercombo-only.csv`
...
| 項目 | 方針 |
|---|---|
| 公式列 | `wiki/outputs/data/frame-data/official/jp/classic.csv` の列をそのまま保持する。 |
...
- Human review decisions: `wiki/outputs/data/frame-data/official-supercombo-enriched/jp/classic-supercombo.csv` の `human_review_*` 列
