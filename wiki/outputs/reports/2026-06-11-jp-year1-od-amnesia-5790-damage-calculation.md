...
JP の Year1 初期ルート `ODアムネジア > 立中K > 強ヴィーハト設置 > 中トルバラン > 強トリグラフ > ヴィーハト爆発 > 中トルバラン > OD中強トリグラフ > SA3` は、hit-by-hit に計算すると 5790 damage になる。
...
この route は、将来 `tools/combo_damage/` の deterministic calculator を作る場合の regression fixture にする。
