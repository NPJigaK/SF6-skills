...
| 派生データは Classic 79 行、Modern 74 行。 | `raw/frame-data/official/elena/manifest.json`; `wiki/outputs/data/frame-data/elena/classic.csv`; `wiki/outputs/data/frame-data/elena/modern.csv` | high | CSV 行数は raw DOM 由来の table row count と対応する。 |
