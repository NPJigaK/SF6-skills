...
| 派生データは Classic 69 行、Modern 65 行。 | `raw/frame-data/official/jp/manifest.json`; `wiki/outputs/data/frame-data/jp/classic.csv`; `wiki/outputs/data/frame-data/jp/modern.csv` | high | CSV 行数は raw DOM 由来の table row count と対応する。 |
