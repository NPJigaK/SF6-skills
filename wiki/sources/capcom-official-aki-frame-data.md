...
4. 表ヘッダの説明は `wiki/outputs/data/frame-data/official/aki/classic.field-meanings.json` と `wiki/outputs/data/frame-data/official/aki/modern.field-meanings.json` に分離して保存されている。
...
| 派生データは Classic 64 行、Modern 57 行。 | `raw/frame-data/official/aki/manifest.json`; `wiki/outputs/data/frame-data/official/aki/classic.csv`; `wiki/outputs/data/frame-data/official/aki/modern.csv` | high | CSV 行数は raw DOM 由来の table row count と対応する。 |
| field meanings は per-move CSV とは別に保存されている。 | `wiki/outputs/data/frame-data/official/aki/classic.field-meanings.json`; `wiki/outputs/data/frame-data/official/aki/modern.field-meanings.json` | high | Classic 7 records、Modern 8 records。 |
...
- Derived Classic CSV: `wiki/outputs/data/frame-data/official/aki/classic.csv`
- Derived Modern CSV: `wiki/outputs/data/frame-data/official/aki/modern.csv`
- Derived field meanings:
  - `wiki/outputs/data/frame-data/official/aki/classic.field-meanings.json`
  - `wiki/outputs/data/frame-data/official/aki/modern.field-meanings.json`
