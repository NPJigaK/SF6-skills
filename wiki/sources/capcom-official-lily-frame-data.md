...
| 派生データは Classic 74 行、Modern 71 行。 | `raw/frame-data/official/lily/manifest.json`; `wiki/outputs/data/frame-data/lily/classic.csv`; `wiki/outputs/data/frame-data/lily/modern.csv` | high | CSV 行数は raw DOM 由来の table row count と対応する。 |
