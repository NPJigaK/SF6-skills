...
created: 2026-06-11
updated: 2026-06-12
source_updated_at: 2023-09-27T14:23:05Z
latest_detail_source_updated_at: 2026-06-02T03:12:40Z
detail_page_count: 17
detail_page_validation_status: passed
...
3. Frontmatter の `source_updated_at` は Patch Notes root page の MediaWiki revid `276775` / revision timestamp `2023-09-27T14:23:05Z` を表す。detail pages の最新 source freshness は `latest_detail_source_updated_at` の `2026-06-02T03:12:40Z`。
4. `validation.batch.json` は `passed`。Patch Notes table 17 rows、detail page capture 17/17、detail validation 17/17 passed、official Battle Change link match 16 rows、official link なし 1 row、official 側だけにある update 4 rows を記録する。
...
根拠は `wiki/outputs/data/battle-change/supercombo-patch-notes/versions.json` と各 detail page の `page.raw.wikitext`。Patch Notes root page の `source_updated_at` は `2023-09-27T14:23:05Z` だが、detail pages の最新 source freshness は `2.0301` の `2026-06-02T03:12:40Z`。
