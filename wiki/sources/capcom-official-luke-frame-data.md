...
title: "Capcom official Luke frame data"
author: "Capcom"
publisher: "Capcom"
...
# Source: Capcom Official Luke Frame Data

## One-line summary

Capcom's official Street Fighter 6 frame data page for Luke (ルーク),
...
|---|---|---|---|
| The source publisher is Capcom and the page is the official Luke frame data URL. | `raw/official/frame-data/2026-05-30/luke/manifest.json`; `raw/official/frame-data/2026-05-30/luke/*/metadata.json` | high | Metadata records publisher, source URL, locale, character slug, and control scheme. |
| Classic and Modern were captured as separate tabs from the same official page. | `raw/official/frame-data/2026-05-30/luke/classic/metadata.json`; `raw/official/frame-data/2026-05-30/luke/modern/metadata.json` | high | Metadata records tab index 0 for Classic and 1 for Modern. |
| The derived data has 76 Classic rows and 73 Modern rows. | `raw/official/frame-data/2026-05-30/luke/manifest.json`; `wiki/outputs/data/frame-data/luke/classic.csv`; `wiki/outputs/data/frame-data/luke/modern.csv` | high | Validation reproduced the same row counts from raw DOM and saved CSV. |
| Header help text is captured outside the row CSV. | `wiki/outputs/data/frame-data/luke/classic.field-meanings.json`; `wiki/outputs/data/frame-data/luke/modern.field-meanings.json` | high | This separates field semantics from per-move rows. |
...
- Which Luke move values, if any, should be promoted into durable
