...
| 派生データは Classic 76 行、Modern 73 行。 | `raw/frame-data/official/luke/manifest.json`; `wiki/outputs/data/frame-data/luke/classic.csv`; `wiki/outputs/data/frame-data/luke/modern.csv` | high | CSV 行数は raw DOM 由来の table row count と対応する。 |
