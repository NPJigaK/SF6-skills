...
| `capture_label` | official / SuperCombo | snapshot の由来を表すラベル。official JP は `2026-05-26`、official Ryu は `2026-05-27`、SuperCombo JP/Ryu は `2026-05-30`。 |
| `created_at_utc` | official | 公式 raw capture の作成時刻。 |
| `captured_at_utc` | SuperCombo | SuperCombo raw capture の取得時刻。 |
...
| SuperCombo raw は `raw/frame-data/supercombo/<character>/` 配下に raw wikitext、Cargo API、DOM、screenshots、images、validation を持つ。 | [[sources/supercombo-jp-frame-data]], [[sources/supercombo-ryu-frame-data]] | high |
| SuperCombo manifest は `storage_policy: latest_frame_data_mirror`、`capture_label`、`source_revision` を持つ。 | `raw/frame-data/supercombo/jp/manifest.json`, `raw/frame-data/supercombo/ryu/manifest.json` | high |
| official + SuperCombo の統合成果物は公式列を正として保持し、SuperCombo は `supercombo_*` 補助列として扱う。 | [[outputs/reports/2026-05-31-jp-official-supercombo-enriched-data]], [[outputs/reports/2026-05-31-ryu-official-supercombo-enriched-data]] | high |
