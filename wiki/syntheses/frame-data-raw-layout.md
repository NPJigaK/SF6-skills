...
| `capture_label` | official / SuperCombo | snapshot の由来を表すラベル。official JP は `2026-05-26`、official Ryu は `2026-05-27`、SuperCombo JP/Ryu は `2026-05-30`、SuperCombo Zangief は `2026-06-01`、SuperCombo Ingrid は `2026-06-02`。 |
...
- SuperCombo Ingrid は派生 output / official crosswalk / 補助列付き output まで作成済み。レビュー対象 26 行は accepted だが、画像は face / portrait 以外の大半が未解決なので、画像を使う分析では manifest / review を確認する。
