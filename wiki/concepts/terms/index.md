...
- SuperCombo Game Data 由来の damage scaling、system data、range comparison、Longest Punish values は community numeric source として扱う。計算に使う頻度が高いため、source page だけでなく [[concepts/terms/damage-scaling]]、[[concepts/system-data]]、[[concepts/range-comparisons]]、[[concepts/terms/guaranteed-punish]] に full table を置く。
...
| [[concepts/terms/damage-scaling]] | ダメージ補正 / damage scaling | [[sources/capcom-esports-base-terms]], [[sources/supercombo-street-fighter-6-glossary]], [[sources/supercombo-street-fighter-6-gauges]], [[sources/supercombo-street-fighter-6-game-data]] | [[concepts/frame-data]], [[concepts/terms/scaling-reset]] |
...
| [[concepts/terms/guaranteed-punish]] | 確定反撃 / punish route | [[sources/capcom-esports-base-terms]], [[sources/supercombo-street-fighter-6-defense]], [[sources/supercombo-street-fighter-6-game-data]] | [[concepts/defense]], [[concepts/frame-data]], [[concepts/range-comparisons]], [[concepts/terms/punish-counter]] |

## SuperCombo Game Data 由来の数値ページ

Game Data page 由来の数値は、計算用の参照頻度が高いため、source page の要約だけでなく full table を reader-facing page に昇格する。いずれも community numeric source であり、公式 source または実機検証と矛盾する場合はそちらを優先する。

| Page | 内容 | Source / output |
|---|---|---|
| [[concepts/terms/damage-scaling]] | SF6 Damage Scaling progression、system-wide scaling、Character-Specific Scaling 30 character tables。 | [[sources/supercombo-street-fighter-6-game-data]]; `raw/web-pages/wiki.supercombo.gg/game-data/derived/tabber-tables.json` tables `0..30` |
| [[concepts/system-data]] | General Data、Movement Data、Jump Data。HP、throw range、walk/dash/jump values。 | [[sources/supercombo-street-fighter-6-game-data]]; `raw/web-pages/wiki.supercombo.gg/game-data/derived/tabber-tables.json` tables `31..33` |
| [[concepts/range-comparisons]] | Cancelable 2MK Range、4f Normal Range / Hitstun / Pushback、5f Punish Options、Sweep Ranges。 | [[sources/supercombo-street-fighter-6-game-data]]; `raw/web-pages/wiki.supercombo.gg/game-data/derived/tabber-tables.json` tables `34..37` |
| [[concepts/terms/guaranteed-punish]] | Longest Punish Option `≤4F` table。`≤5F`..`≤12F` は source 上 `(to-do)`。 | [[sources/supercombo-street-fighter-6-game-data]]; `raw/web-pages/wiki.supercombo.gg/game-data/derived/tabber-tables.json` table `38` |
