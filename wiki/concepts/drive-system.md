...
| [[concepts/terms/raw-drive-rush|生ラッシュ]] は Drive Parry の構えを cancel して出す Drive Rush、`キャンセルラッシュ` は通常技を cancel して出す Drive Rush として説明される。 | [[sources/capcom-esports-base-terms]] | high |
