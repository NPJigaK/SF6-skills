...
| SuperCombo HUD page は Combo Counter を現在の combo hit 数の表示として説明し、true combo かどうかの判断補助になると述べる。 | [[sources/supercombo-street-fighter-6-hud]] | medium |
| SuperCombo HUD page は Counter-hit icon を相手攻撃の startup / active への割り込み、Punish Counter icon を相手の recovery への punish として説明する。 | [[sources/supercombo-street-fighter-6-hud]] | medium |
...
- SuperCombo HUD page は HUD icon の display cue source として使う。Counter / Punish Counter の advantage や damage、個別技の frame value は公式 term source や frame-data output を優先する。
