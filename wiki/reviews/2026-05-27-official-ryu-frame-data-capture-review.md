...
この review page の date-based raw path は 2026-05-27 時点の履歴表記。現在の raw entrypoint は `raw/frame-data/official/ryu/manifest.json` の latest mirror 固定パスで、capture date / source revision は manifest fields で確認する。
