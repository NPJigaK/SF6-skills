...
- Derived runtime asset target: `runtime/frame-current/`
...
8. Rebuild frame-current runtime assets so the target is `runtime/frame-current/`.
...
- `asset_root = runtime/frame-current`
