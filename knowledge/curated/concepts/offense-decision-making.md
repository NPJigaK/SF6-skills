---
id: sf6-concept-offense-decision-making
title: Offensive Decision Concepts
claim_kind: stable_concept
source_kind: maintainer_note
source_role: migrated stable concept material
evidence_basis:
  - "Hit confirming and wake-up pressure are stable decision concepts that describe player choices rather than exact current values."
  - "The migrated material is limited to conceptual boundaries and excludes character-specific routes or setup claims."
...
must_not_include:
  - "character-specific confirm windows"
  - "exact routes, setup timings, or guaranteed wake-up options"
---
